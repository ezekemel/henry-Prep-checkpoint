...
function menorMayor(numeros) {
  ...
  //devuelva un arreglo 
  // que contenga el menor número del arreglo en la posición cero y el mayor
  // número del arreglo en la posición 1.
...
function sumArray(array, n) {
  ...
  // te devuelva true si alguna combinación de dos números cualesquiera suman n, y devuelva
  // false si ninguna combinación
...
function pluck(array, propiedad) { 
  ...
  var nuevoArray = array.map(function (objeto) {
...
function crearClasePersona() {
  ...
  class Persona {
    ...
    getFriends() {
      ...
      var arrayAmigos = this.amigos.map(function (objeto) {
